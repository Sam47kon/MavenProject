...
public class Task10 {
    ...
    private char[] getCharFromText(String inText) {
    ...
    private int getConsonantsQuantity(char[] charArrayInText) {
        ...
        for (char c : charArrayInText) {     // проверяем каждое значение массива на предмет вхождения в контейнер согласных
    ...
    private int getVowelsQuantity(char[] charArrayInText) {
        int vowelsQuantity = 0;    // количество гласных
        Set<Character> vowels = Set.of('a', 'e', 'y', 'u', 'i', 'o', 'о', 'и', 'е', 'а', 'ё', 'э', 'ы', 'у', 'ю', 'я');    // контейнер гласных //
        for (char c : charArrayInText) {    // проверяем каждое значение массива на предмет вхождения в контейнер гласных
