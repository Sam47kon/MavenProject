...
public class Task17 {
    double solutionOfEquation1(double x1, double x2) {    // a) длина гипотенузы
    ...
    double solutionOfEquation6(double m, double g, double angle) {    // е)
        return (m * g * Math.cos(angle));
    }

    double solutionOfEquation7(double r) {    // ж)
        return (2 * Math.PI * r);
    }
    ...
    double solutionOfEquation10(double m1, double m2, double r) {    // и)
        double GAMMA = 0.;
